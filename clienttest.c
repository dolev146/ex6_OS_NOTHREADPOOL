...
int main()
{
    ...
    pthread_t tid2;
    if (pthread_create(&tid2, NULL, cientThreadbbb, NULL) != 0)
    {
        printf("Failed to create thread\n");
    }
    ...
    pthread_t tid3;
    if (pthread_create(&tid3, NULL, cientThreadccc, NULL) != 0)
    {
        printf("Failed to create thread\n");
    }
    ...
    pthread_t tid4;
    if (pthread_create(&tid4, NULL, cientThreadddd, NULL) != 0)
    {
        printf("Failed to create thread\n");
    }
